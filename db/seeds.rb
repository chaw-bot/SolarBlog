...
user1 = User.create!( name: 'Lenny', photo: image, bio: bio, posts_counter: 0, email: 'lenny@mail.com', password: 'r89eudhbgvb' )
user2 = User.create!( name: 'Mel', photo: image, bio: bio, posts_counter: 0, email: 'mel@mail.com', password: 'r89eudhbgvb' )
user3 = User.create!( name: 'Joe', photo: image, bio: bio, posts_counter: 0, email: 'joe@mail.com', password: 'r89eudhbgvb' )
user4 = User.create!( name: 'Paulo', photo: image, bio: bio, posts_counter: 0, email: 'paulo@mail.com', password: 'r89eudhbgvb')
