...
RSpec.feature 'post index page', js: true, type: :feature do
  background do
    ...
    @post = @lenny.posts.create!(title: 'To Be',
                                 text: 'The big question is: "To be or not to be a Ruby programmer"', likes_counters: 0,
                                 comments_counter: 0)
    @lenny.posts.create!(title: 'Is it a Language?', text: 'Why people say HTML is not a programming language...',
